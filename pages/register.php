  ...
  <body>
    ...
    <div class="container">
      <form class="form-container">
        ...
        <div class="row mt-5 respon">
        <div class="col-md-7">
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Nama Lengkap</label>
          <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
        ...
        <div class="col-md-7">
          <div class="mb-3">
            ...
            <div class="input-group mb-3">
              <span class="input-group-text" id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
        ...
        <div class="mt-3">
          <label>Sudah punya akun? <a href="index.html" class="text-login">Login disini</label>
        </div>
      </form>
